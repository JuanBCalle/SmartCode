...
export class MensajeController {
  constructor(
    ...
    @repository(NotificacionesService)
  ...
  async create(
    ...
    let empleadoEncontrado = this.empleadoRepository.findById(mensaje.empleadoId);
    if (empleadoEncontrado) {
      let telefono = (await empleadoEncontrado).Telefono;
      this.notificaciones.EnviarMensajePorSMS(telefono, mensaje.Body);
    }
